...
/**
 * @author Chi
 * The class to maintain default namespaces.
 */
public class Namespace {
    
	
	/**
	 * Default IFC2X3_TC1 namespace.
	 */
	public static final String IFC2X3_TC1 = "http://ifcowl.openbimstandards.org/IFC2X3_TC1#";
	/**
	 * Default IFC2X3_Final namespace.
	 */
